...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"display\": () => (/* binding */ display),\n/* harmony export */   \"modifyItem\": () => (/* binding */ modifyItem)\n/* harmony export */ });\n/* harmony import */ var _declaration_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./declaration.js */ \"./src/modules/declaration.js\");\n/* harmony import */ var _insert_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./insert.js */ \"./src/modules/insert.js\");\n\n\n\n// local storage\nlet todo;\nconst todos = JSON.parse(localStorage.getItem('todos')) || [];\n\nfunction store() {\n  todo = {\n    description: _declaration_js__WEBPACK_IMPORTED_MODULE_0__.todoInput.value,\n    id: todos.length + 1,\n    completed: false,\n  };\n\n  todos.push(todo);\n  localStorage.setItem('todos', JSON.stringify(todos));\n}\n\nconst clear = () => {\n  _declaration_js__WEBPACK_IMPORTED_MODULE_0__.todoInput.value = '';\n};\n\nconst modifyItem = () => {\n  const updateTodo = document.querySelectorAll('.newInput');\n  updateTodo.forEach((edits, indexy) => {\n    edits.addEventListener('change', () => {\n      todos.forEach((todo, index) => {\n        if (indexy === index) {\n          todo.Description = edits.value;\n          localStorage.setItem('todos', JSON.stringify(todos));\n        }\n      });\n    });\n  });\n};\nmodifyItem();\n\nconst display = () => {\n  _declaration_js__WEBPACK_IMPORTED_MODULE_0__.form.addEventListener('keydown', (e) => {\n    if (_declaration_js__WEBPACK_IMPORTED_MODULE_0__.todoInput.value !== '' && e.key === 'Enter') {\n      store();\n      (0,_insert_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(todo);\n      clear();\n    }\n  });\n};\n\ndisplay();\n\n\n\n\n//# sourceURL=webpack://web-pack/./src/modules/addList.js?");

/***/ }),

/***/ "./src/modules/declaration.js":
/*!************************************!*\
  !*** ./src/modules/declaration.js ***!
  \************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"form\": () => (/* binding */ form),\n/* harmony export */   \"todoInput\": () => (/* binding */ todoInput),\n/* harmony export */   \"todos\": () => (/* binding */ todos)\n/* harmony export */ });\nconst todoInput = document.getElementById('todo-input');\nconst form = document.getElementById('todo-input');\nconst todos = JSON.parse(localStorage.getItem('todos')) || [];\n\n\n//# sourceURL=webpack://web-pack/./src/modules/declaration.js?");

/***/ }),

/***/ "./src/modules/insert.js":
/*!*******************************!*\
  !*** ./src/modules/insert.js ***!
  \*******************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _removeItem_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./removeItem.js */ \"./src/modules/removeItem.js\");\n\n\nconst todos = JSON.parse(localStorage.getItem('todos')) || [];\n\nconst addTasks = (todo) => {\n  const container = document.getElementById('todos-container');\n  const todoHolder = document.createElement('div');\n  todoHolder.classList.add('todoActivity');\n  const checkbox = document.createElement('input');\n  checkbox.type = 'checkbox';\n  checkbox.classList.add('checkbox');\n  const newInput = document.createElement('input');\n  newInput.type = 'text';\n  newInput.classList.add('newInput');\n  newInput.value = todo.description;\n  const icon = document.createElement('i');\n  icon.classList.add('fa-solid');\n  icon.classList.add('fa-trash');\n  icon.classList.add('dots');\n  todoHolder.append(checkbox, newInput, icon);\n  container.append(todoHolder);\n  // delete activity\n  icon.addEventListener('click', () => {\n    // ev.preventDefault();\n    icon.parentElement.remove();\n    (0,_removeItem_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(todo.id);\n  });\n};\n\ntodos.forEach(addTasks);\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (addTasks);\n\n\n//# sourceURL=webpack://web-pack/./src/modules/insert.js?");
